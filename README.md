...
| Storyboard | Aligns the approved script to your takes; your hired director proposes cuts, framing, graphics, pacing, punch-line captions and sound temperament.                                                               | Which director you hire (Purist / Craftsman / Showman), take selection, scene edits, revision requests, and storyboard approval. |
...
| Review     | Opens the rough cut with QA results and supports scene or range revisions. Approval starts final rendering — through Resolve, or the verified FFmpeg master when captions or narration processing are burned in. | Playback review, factual accuracy, media rights, edits, and rough-cut approval.                                                  |
