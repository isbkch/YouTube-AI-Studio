...
WTS_APP="$WTS_REPO_ROOT/dist/yt-ai-studio.app"
...
with open(sys.argv[1]+'/Contents/Info.plist','wb') as f:
 plistlib.dump({'CFBundleName':'yt-ai-studio','CFBundleDisplayName':'yt-ai-studio','CFBundleIdentifier':'com.isbkch.yt-ai-studio','CFBundleExecutable':'YTAIStudio','CFBundleIconFile':'AppIcon','CFBundlePackageType':'APPL','CFBundleShortVersionString':'0.1.0','CFBundleVersion':'1','LSMinimumSystemVersion':'14.0','NSHighResolutionCapable':True,'WTSRuntimeRoot':sys.argv[2]},f)
PY
cp "$WTS_REPO_ROOT/apps/macos/Resources/AppIcon.icns" "$WTS_APP/Contents/Resources/AppIcon.icns"
codesign --force --sign - "$WTS_APP"

WTS_INSTALLED_APP="/Applications/yt-ai-studio.app"
