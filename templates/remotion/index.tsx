...
const defaults: VisualProps = {
  template: "Callout",
  parameters: {
    title: "Redundancy is not high availability.",
    subtitle: "WinTheCloud • Field notes on reliable systems",
    nodes: [],
    emphasis: -1,
  },
  brand: {
      ...
      >
        ...
        {props.template === "ArchitectureFlow" ? (
          <>
            <div
              style={{
                ...
                top: 132,
                right: 64,
                fontSize: p.title.length > 65 ? 42 : 50,
                fontWeight: 600,
                letterSpacing: -1.7,
                opacity: enter,
                lineHeight: 1.15,
                ...
                <React.Fragment key={i}>
                  ...
                  <div
                    style={{
                      ...
                      minWidth: 0,
                      height: 142,
                      border: `1.5px solid ${i === p.emphasis ? "#ef9988" : b.accent + "65"}`,
                      background: i === p.emphasis ? "#35272b" : "#172637",
                      borderRadius: 14,
                      padding: "22px 16px",
                  ...
                  >
                    <div
                      style={{
                        ...label,
                        fontSize: 13,
                        color: i === p.emphasis ? "#ef9988" : b.accent,
                        marginBottom: 22,
                      }}
                    >
                      {i === p.emphasis
                    ...
                    <div
                      style={{
                        fontSize: p.nodes.length > 4 ? 22 : 27,
                        lineHeight: 1.12,
                        fontWeight: 500,
          ...
          >
            ...
            <div
              style={{
                fontSize: p.title.length > 70 ? 58 : 72,
                lineHeight: 1.09,
                fontWeight: 550,
                letterSpacing: -2.2,
                maxWidth: 1110,
